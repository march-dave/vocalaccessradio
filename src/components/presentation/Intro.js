			...
			<div>
				...
				<section id="turbo" style={{marginTop:64}} className="bottommargin-lg">
					<div className="container" style={style.container}>
						...
						<p style={style.paragraph}>
							...
							backend with database but want to store data, <a target="_blank" style={{color:'red'}} href="http://www.turbo360.co/">Turbo</a> is 
							a good solution. To add a backend, register a project on <a target="_blank" style={{color:'red'}} href="http://www.turbo360.co/">Turbo</a> then from the root directory:
						</p>
				...
				<section id="dashboard" style={{marginTop:64}} className="bottommargin-lg">
					<div className="container" style={style.container}>
						...
						<hr />
						<p style={style.paragraph}>
							All entities for your project can be managed on the <a target="_blank" style={{color:''}} href="http://www.turbo360.co/">Turbo Dashboard</a>. 
